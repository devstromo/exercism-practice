...
public class RotationalCipherTest {
    ...
    @Test
    public void rotateCapitalLetters1() {
        rotationalCipher = new RotationalCipher(5);
        Assert.assertEquals("T", rotationalCipher.rotate("O"));
    }
    ...
    public void rotateAllLetters() {
        rotationalCipher = new RotationalCipher(13);
        Assert.assertEquals("The quick brown fox jumps over the lazy dog.", rotationalCipher.rotate("Gur dhvpx oebja sbk whzcf bire gur ynml qbt."));
    }
}
